      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8">
        <div className="flex justify-between  items-center h-full">
          ...
          <div className="hidden pt-3 lg:flex flex-grow items-center justify-center space-x-6">
            <Link
              to="/"
              className="text-black px-3 py-2 text-sm md:text-base font-medium"
            >
              Home
            </Link>
            <Link
          ...
          <div className="hidden pt-3 lg:flex items-center space-x-4">
            <FontAwesomeIcon
              icon={faContactCard}
      ...
      {isOpen && (
        <div className="lg:hidden bg-white shadow-md">
          <div className="px-2 pt-2 pb-3 space-y-1">
            <Link
              to="/"
              className="block text-black px-3 py-2 text-base font-medium"
            >
              Home
            </Link>
            <Link
