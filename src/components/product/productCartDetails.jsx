    ...
    <div className="container mx-auto p-6 mt-16">
      <div className="flex flex-col lg:flex-row lg:space-x-12">
        ...
        <div className="w-full lg:w-1/2 mt-6 lg:mt-0">
          <h1 className="text-3xl lg:text-4xl font-semibold mb-4">Asgaard Sofa</h1>
          <p className="text-2xl text-[#9F9F9F] font-semibold mb-2">Rs. 250,000.00</p>
          ...
          <div className="mb-4">
            ...
            <div className="flex flex-wrap space-x-2">
              {["XS", "L", "XL"].map((sizeOption) => (
                <button
                  key={sizeOption}
                  className={`py-2 px-4 border ${size === sizeOption ? "bg-[#B88E2F] text-white" : "bg-[#F9F1E7]"} rounded-lg`}
          ...
          <div className="mb-4">
            ...
            <div className="flex flex-wrap space-x-2">
              {["#816DFA", "#000", "#B88E2F"].map((colorOption, index) => (
                <div
                  key={index}
                  className={`w-8 h-8 rounded-full cursor-pointer border ${color === colorOption ? "border-black" : "border-gray-300"}`}
          ...
          <div className="mb-4 flex items-center space-x-4">
            ...
            <button className="px-4 py-2 text-[#9F9F9F] rounded-lg" onClick={() => handleQuantityChange("decrement")}>-</button>
            <span>{quantity}</span>
            <button className="px-4 py-2 text-[#9F9F9F] rounded-lg" onClick={() => handleQuantityChange("increment")}>+</button>
          </div>
          ...
          <div className="text-[#9F9F9F] mb-4">
            <p>SKU: <span className="text-gray-[#9F9F9F]">SS001</span></p>
            <p>Category: <span className="text-gray-[#9F9F9F]">Sofas</span></p>
            <p>Tags: <span className="text-gray-[#9F9F9F]">Sofa, Chair, Home, Shop</span></p>
          </div>
